...
L["Select the woodcutting nodes you wish to display."] = true
...
L["Toggle showing woodcutting nodes."] = true
...
NL["Battered Footlocker 2"] = true
NL["Battered Footlocker 3"] = true
NL["Black Lotus"] = true
NL["Blindweed"] = true
...
NL["Dented Footlocker 2"] = true
NL["Dented Footlocker 3"] = true
NL["Dented Footlocker 4"] = true
NL["Draenei Woodcutting Find"] = true
NL["Dragon's Teeth"] = true
NL["Dragonfin Angelfish School"] = true
NL["Dreamfoil"] = true
NL["Dreaming Glory"] = true
NL["Dwarf Woodcutting Find"] = true
NL["Earthroot"] = true
...
NL["Fossil Woodcutting Find"] = true
NL["Frost Lotus"] = true
NL["Frozen Herb"] = true
...
NL["Large Iron Bound Chest 2"] = true
NL["Large Iron Bound Chest 3"] = true
NL["Large Iron Bound Chest 4"] = true
...
NL["Orc Woodcutting Find"] = true
NL["Other Woodcutting Find"] = true
...
NL["Tol'vir Woodcutting Find"] = true
NL["Troll Woodcutting Find"] = true
NL["Truesilver Deposit"] = true
NL["Twilight Jasmine"] = true
NL["Un'Goro Dirt Pile"] = true
NL["Vrykul Woodcutting Find"] = true
NL["Waterlogged Footlocker"] = true
NL["Waterlogged Footlocker 2"] = true
NL["Waterlogged Footlocker 3"] = true
NL["Waterlogged Wreckage"] = true
NL["Wicker Chest"] = true
NL["Wild Steelbloom"] = true
NL["Windy Cloud"] = true
NL["Wintersbite"] = true
NL["Ashenvale Tree"] = true
NL["Azshara Tree"] = true
NL["Darkshore Tree"] = true
NL["Dun Morogh Tree"] = true
NL["Durotar Tree"] = true
NL["Duskwood Tree"] = true
NL["Elwynn Tree"] = true
NL["Felwood Tree"] = true
NL["Hillsbrad Tree"] = true
NL["Hinterland Tree"] = true
NL["Loch Modan Tree"] = true
NL["Mulgore Tree"] = true
NL["Plagueland Stump"] = true
NL["Plagueland Tree"] = true
NL["Redridge Tree"] = true
NL["Silverpine Tree"] = true
NL["Stonetalon Tree"] = true
NL["Swamp Stump"] = true
NL["Teldrassil Tree"] = true
...
NL["Miru Berry"] = true
NL["Blue Power Crystal"] = true
NL["Green Power Crystal"] = true
NL["Red Power Crystal"] = true
NL["Yellow Power Crystal"] = true
